...
require (
	...
	github.com/go-i2p/go-i2cp v0.1.3 // indirect
	github.com/go-i2p/go-i2p v0.1.3 // indirect
	github.com/go-i2p/go-noise v0.1.3 // indirect
	github.com/go-i2p/go-sam-bridge v0.1.3 // indirect
